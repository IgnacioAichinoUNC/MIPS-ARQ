...
module TOP_MIPS
    ...
    (   
        ...
        //input   wire     [BITS_SIZE-1:0]            i_select_mem_dir, //Se utiliza para selecct memoria de dato
...
// Unidad Riesgos
    ...
    wire                            ifid_risk_write;  //Riesgo de escritura
// ---------IDEX-----------------------------------------------
//ID/EX/CONTROL
...
//MEM
    wire                            MEM_PC_src_o; ///ESTE validar output
...
///LATCH IF/ID
    ...
    (
        ...
        .i_reset                    (i_reset),
        .i_step                     (i_ctl_clk_wiz),
        .i_IFID_risk_write          (ifid_risk_write),
        .i_pc4                      (IF_PC4_o),
        .i_pc8                      (IF_PC8_o),
